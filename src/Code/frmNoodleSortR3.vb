Public Class frmNoodleSortR3
    Dim isDragging As Boolean = False, isClick As Boolean = False
    Dim startPoint, firstPoint, lastPoint As Point
    Dim seconds, bowtiePoints, pennePoints, shellPoints, spiralPoints, macaroniPoints, ravioliPoints, win As Integer



    Private Sub tmrRound3_Tick(sender As Object, e As EventArgs) Handles tmrRound3.Tick
        lblTime.Text = seconds
        seconds -= 1

        If seconds = 0 Or picBowtie1.Visible = False And picBowtie2.Visible = False And
        ...
        picSpiral3.Visible = False And picSpiral4.Visible = False And picSpiral5.Visible = False And
        picMacaroni1.Visible = False And picMacaroni2.Visible = False And picMacaroni3.Visible = False And
        picMacaroni4.Visible = False And picMacaroni5.Visible = False And picRavioli1.Visible = False And
        picRavioli2.Visible = False And picRavioli3.Visible = False And picRavioli4.Visible = False And
        picRavioli5.Visible = False Then
            lblTime.Text = seconds
            tmrRound3.Stop()
            MessageBox.Show("Round over" & vbNewLine & vbNewLine & "SUCCESS" & vbNewLine & vbNewLine & "You win!", "Round 3", MessageBoxButtons.OK)
            win = True
    ...
    'picMacaroni1
    Private Sub picMacaroni1_Click(sender As Object, e As EventArgs) Handles picMacaroni1.Click
        isClick = True
    End Sub

    Private Sub picMacaroni1_MouseDown(sender As Object, e As MouseEventArgs) Handles picMacaroni1.MouseDown
        startPoint = picMacaroni1.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picMacaroni1_MouseMove(sender As Object, e As MouseEventArgs) Handles picMacaroni1.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picMacaroni1.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picMacaroni1, EndPoint)
        End If
    End Sub

    Private Sub picMacaroni1_MouseUp(sender As Object, e As MouseEventArgs) Handles picMacaroni1.MouseUp
        MouseUpProc(picMacaroni1, lblMacaroni, macaroniPoints, lblMacaroniPoints, startPoint)
    End Sub

    'picMacaroni2
    Private Sub picMacaroni2_Click(sender As Object, e As EventArgs) Handles picMacaroni2.Click
        isClick = True
    End Sub

    Private Sub picMacaroni2_MouseDown(sender As Object, e As MouseEventArgs) Handles picMacaroni2.MouseDown
        startPoint = picMacaroni2.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picMacaroni2_MouseMove(sender As Object, e As MouseEventArgs) Handles picMacaroni2.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picMacaroni2.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picMacaroni2, EndPoint)
        End If
    End Sub

    Private Sub picMacaroni2_MouseUp(sender As Object, e As MouseEventArgs) Handles picMacaroni2.MouseUp
        MouseUpProc(picMacaroni2, lblMacaroni, macaroniPoints, lblMacaroniPoints, startPoint)
    End Sub

    'picMacaroni3
    Private Sub picMacaroni3_Click(sender As Object, e As EventArgs) Handles picMacaroni3.Click
        isClick = True
    End Sub

    Private Sub picMacaroni3_MouseDown(sender As Object, e As MouseEventArgs) Handles picMacaroni3.MouseDown
        startPoint = picMacaroni3.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picMacaroni3_MouseMove(sender As Object, e As MouseEventArgs) Handles picMacaroni3.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picMacaroni3.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picMacaroni3, EndPoint)
        End If
    End Sub

    Private Sub picMacaroni3_MouseUp(sender As Object, e As MouseEventArgs) Handles picMacaroni3.MouseUp
        MouseUpProc(picMacaroni3, lblMacaroni, macaroniPoints, lblMacaroniPoints, startPoint)
    End Sub

    'picMacaroni4
    Private Sub picMacaroni4_Click(sender As Object, e As EventArgs) Handles picMacaroni4.Click
        isClick = True
    End Sub

    Private Sub picMacaroni4_MouseDown(sender As Object, e As MouseEventArgs) Handles picMacaroni4.MouseDown
        startPoint = picMacaroni4.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picMacaroni4_MouseMove(sender As Object, e As MouseEventArgs) Handles picMacaroni4.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picMacaroni4.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picMacaroni4, EndPoint)
        End If
    End Sub

    Private Sub picMacaroni4_MouseUp(sender As Object, e As MouseEventArgs) Handles picMacaroni4.MouseUp
        MouseUpProc(picMacaroni4, lblMacaroni, macaroniPoints, lblMacaroniPoints, startPoint)
    End Sub

    'picMacaroni5
    Private Sub picMacaroni5_Click(sender As Object, e As EventArgs) Handles picMacaroni5.Click
        isClick = True
    End Sub

    Private Sub picMacaroni5_MouseDown(sender As Object, e As MouseEventArgs) Handles picMacaroni5.MouseDown
        startPoint = picMacaroni5.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picMacaroni5_MouseMove(sender As Object, e As MouseEventArgs) Handles picMacaroni5.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picMacaroni5.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picMacaroni5, EndPoint)
        End If
    End Sub

    Private Sub picMacaroni5_MouseUp(sender As Object, e As MouseEventArgs) Handles picMacaroni5.MouseUp
        MouseUpProc(picMacaroni5, lblMacaroni, macaroniPoints, lblMacaroniPoints, startPoint)
    End Sub

    'picRavioli1
    Private Sub picRavioli1_Click(sender As Object, e As EventArgs) Handles picRavioli1.Click
        isClick = True
    End Sub

    Private Sub picRavioli1_MouseDown(sender As Object, e As MouseEventArgs) Handles picRavioli1.MouseDown
        startPoint = picRavioli1.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picRavioli1_MouseMove(sender As Object, e As MouseEventArgs) Handles picRavioli1.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picRavioli1.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picRavioli1, EndPoint)
        End If
    End Sub

    Private Sub picRavioli1_MouseUp(sender As Object, e As MouseEventArgs) Handles picRavioli1.MouseUp
        MouseUpProc(picRavioli1, lblRavioli, ravioliPoints, lblRavioliPoints, startPoint)
    End Sub

    'picRavioli2
    Private Sub picRavioli2_Click(sender As Object, e As EventArgs) Handles picRavioli2.Click
        isClick = True
    End Sub

    Private Sub picRavioli2_MouseDown(sender As Object, e As MouseEventArgs) Handles picRavioli2.MouseDown
        startPoint = picRavioli2.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picRavioli2_MouseMove(sender As Object, e As MouseEventArgs) Handles picRavioli2.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picRavioli2.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picRavioli2, EndPoint)
        End If
    End Sub

    Private Sub picRavioli2_MouseUp(sender As Object, e As MouseEventArgs) Handles picRavioli2.MouseUp
        MouseUpProc(picRavioli2, lblRavioli, ravioliPoints, lblRavioliPoints, startPoint)
    End Sub

    'picRavioli3
    Private Sub picRavioli3_Click(sender As Object, e As EventArgs) Handles picRavioli3.Click
        isClick = True
    End Sub

    Private Sub picRavioli3_MouseDown(sender As Object, e As MouseEventArgs) Handles picRavioli3.MouseDown
        startPoint = picRavioli3.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picRavioli3_MouseMove(sender As Object, e As MouseEventArgs) Handles picRavioli3.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picRavioli3.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picRavioli3, EndPoint)
        End If
    End Sub

    Private Sub picRavioli3_MouseUp(sender As Object, e As MouseEventArgs) Handles picRavioli3.MouseUp
        MouseUpProc(picRavioli3, lblRavioli, ravioliPoints, lblRavioliPoints, startPoint)
    End Sub

    'picRavioli4
    Private Sub picRavioli4_Click(sender As Object, e As EventArgs) Handles picRavioli4.Click
        isClick = True
    End Sub

    Private Sub picRavioli4_MouseDown(sender As Object, e As MouseEventArgs) Handles picRavioli4.MouseDown
        startPoint = picRavioli4.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picRavioli4_MouseMove(sender As Object, e As MouseEventArgs) Handles picRavioli4.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picRavioli4.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picRavioli4, EndPoint)
        End If
    End Sub

    Private Sub picRavioli4_MouseUp(sender As Object, e As MouseEventArgs) Handles picRavioli4.MouseUp
        MouseUpProc(picRavioli4, lblRavioli, ravioliPoints, lblRavioliPoints, startPoint)
    End Sub

    'picRavioli5
    Private Sub picRavioli5_Click(sender As Object, e As EventArgs) Handles picRavioli5.Click
        isClick = True
    End Sub

    Private Sub picRavioli5_MouseDown(sender As Object, e As MouseEventArgs) Handles picRavioli5.MouseDown
        startPoint = picRavioli5.PointToScreen(New Point(e.X, e.Y))
        MouseDownProc(startPoint)
    End Sub

    Private Sub picRavioli5_MouseMove(sender As Object, e As MouseEventArgs) Handles picRavioli5.MouseMove
        If isDragging Then
            Dim EndPoint As Point = picRavioli5.PointToScreen(New Point(e.X, e.Y))
            MouseMoveProc(picRavioli5, EndPoint)
        End If
    End Sub

    Private Sub picRavioli5_MouseUp(sender As Object, e As MouseEventArgs) Handles picRavioli5.MouseUp
        MouseUpProc(picRavioli5, lblRavioli, ravioliPoints, lblRavioliPoints, startPoint)
    End Sub

    Private Sub frmNoodleSortR3_Load(sender As Object, e As EventArgs) Handles Me.Load
        My.Computer.Audio.Stop()
